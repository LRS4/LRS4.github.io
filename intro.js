...
// filter by subject
$("#myBtncontent").attr("data-intro", "Select to filter by category.").attr("data-step", "2");
...
// top nav
$("#myTopnav").attr("data-intro", "Further information can be found here.").attr("data-step", "4").attr("data-scrollTo", "top");
